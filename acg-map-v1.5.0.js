/*
  acg-map v1.5.0 (CDN file acg-map-v1.5.0.js; v1.4.0 stays at acg-map-v1.4.0.js, v1.3.0 at
  acg-map-v1.3.0.js, v1.2.0 at acg-map-v1.2.0.js, v1.1.0 at acg-map-v1.1.0.js, v1.0.0 at
  acg-map-v1.js). The
  ...
  Loader line: <script src="https://cdn.allcare-ga.com/acg-map-v1.5.0.js"
  ...
  Card taps (v1.5.0, Connor's phase 1 staging review, 2026-09-24): a card tap scrolls the
  map into view at every width, pans to the clinic and opens its window. v1.4.0 (round 12,
  item 5) had stopped the scroll at 767px and down, when the map sat above the list; since
  round 13 the list sits above the map on a phone, so the tap takes the visitor down to it.
...
(function () {
  ...
  // A card click scrolls the map into view, pans it to that clinic and opens its window
  // (v1.5.0: at every width). Links and buttons inside the card still navigate.
